...
Ihvpk = Ihv*sqrt(2);
%% Sources
tonvsc = 0.02; % Time instant to connect the VSCs
...
G1gen = 0.20;   %    (400 MW nominal)
G2gen = 0.30;   % WF (300 MW nominal)
G3gen = 0.25;   % PV (200 MW nominal)
G5gen = 0.22;   % WF (300 MW nominal)
G6gen = 0.41;   % PV (400 MW nominal)
G7gen = 0.52;   % SG (200 MW nominal)
