...
G1gen = 0.298581; %0.67934   %    (400 MW nominal)
G2gen = 0.70;   % WF (300 MW nominal)
G3gen = 0.90;   % PV (200 MW nominal)
G4sgen = 0.8186; % ST (200 MW nominal)
G5gen = 0.80;   % WF (300 MW nominal)
G6gen = 0.81797; % PV (400 MW nominal)
G6sgen = 0.7;  % ST (200 MW nominal)
G7gen = 0.5098;% SG (200 MW nominal)
...
%% Loads
% System base Load
St = (S1non*G1gen + S2non*G2gen + S3non*G3gen + S4snon*G4sgen + S5non*G5gen + S6non*G6gen + S6snon*G6gen + S7non*G7gen); % Total power generated (VA)
Sr = 1900e6; % Base apparent power (VA)
